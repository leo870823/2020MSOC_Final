...
// ==============================================================
#ifndef __cross_channel_debfYi__HH__
#define __cross_channel_debfYi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(cross_channel_debfYi) {
    ...
    SC_CTOR(cross_channel_debfYi):  ACMP_dadddsub_U ("ACMP_dadddsub_U") {
