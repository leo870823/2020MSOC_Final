...
// ==============================================================
#ifndef __cross_channel_debjbC__HH__
#define __cross_channel_debjbC__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(cross_channel_debjbC) {
    ...
    SC_CTOR(cross_channel_debjbC):  simcore_mac_0_U ("simcore_mac_0_U") {
