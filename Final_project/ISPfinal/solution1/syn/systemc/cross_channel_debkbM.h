...
// ==============================================================
#ifndef __cross_channel_debkbM__HH__
#define __cross_channel_debkbM__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(cross_channel_debkbM) {
    ...
    SC_CTOR(cross_channel_debkbM):  simcore_mac_1_U ("simcore_mac_1_U") {
