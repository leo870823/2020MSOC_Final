...
architecture behav of fft_top is 
    ...
    signal dummy_proc_fe_1_U0_in_r_address0 : STD_LOGIC_VECTOR (13 downto 0);
    signal dummy_proc_fe_1_U0_in_r_ce0 : STD_LOGIC;
    signal dummy_proc_fe_1_U0_out_r_din : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal dummy_proc_be_1_U0_out_r_address0 : STD_LOGIC_VECTOR (13 downto 0);
    signal dummy_proc_be_1_U0_out_r_ce0 : STD_LOGIC;
    signal dummy_proc_be_1_U0_out_r_we0 : STD_LOGIC;
    signal dummy_proc_be_1_U0_out_r_d0 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    component start_for_fft_conlbW IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component start_for_dummy_pmb6 IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
...
begin
    ...
    xn_channel_U : component fifo_w32_d16384_A
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    xk_channel_U : component fifo_w32_d16384_A
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_fft_conlbW_U : component start_for_fft_conlbW
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_dummy_pmb6_U : component start_for_dummy_pmb6
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
