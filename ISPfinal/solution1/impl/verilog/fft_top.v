...
wire   [13:0] dummy_proc_fe_1_U0_in_r_address0;
wire    dummy_proc_fe_1_U0_in_r_ce0;
wire   [31:0] dummy_proc_fe_1_U0_out_r_din;
...
wire    dummy_proc_be_1_U0_status_in_data_V_read;
wire    dummy_proc_be_1_U0_ovflo;
wire    dummy_proc_be_1_U0_ovflo_ap_vld;
wire    dummy_proc_be_1_U0_in_r_read;
wire   [13:0] dummy_proc_be_1_U0_out_r_address0;
wire    dummy_proc_be_1_U0_out_r_ce0;
wire    dummy_proc_be_1_U0_out_r_we0;
wire   [31:0] dummy_proc_be_1_U0_out_r_d0;
...
fifo_w32_d16384_A xn_channel_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
fifo_w32_d16384_A xk_channel_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
start_for_fft_conlbW start_for_fft_conlbW_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
start_for_dummy_pmb6 start_for_dummy_pmb6_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
assign ovflo = dummy_proc_be_1_U0_ovflo;

assign ovflo_ap_vld = dummy_proc_be_1_U0_ovflo_ap_vld;
