...
// ==============================================================
#ifndef __DEBLUR_fpext_32nspcA__HH__
#define __DEBLUR_fpext_32nspcA__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(DEBLUR_fpext_32nspcA) {
    ...
    SC_CTOR(DEBLUR_fpext_32nspcA):  ACMP_fpext_U ("ACMP_fpext_U") {
