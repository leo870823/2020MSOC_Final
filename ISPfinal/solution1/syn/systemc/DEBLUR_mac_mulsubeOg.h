...
// ==============================================================
#ifndef __DEBLUR_mac_mulsubeOg__HH__
#define __DEBLUR_mac_mulsubeOg__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(DEBLUR_mac_mulsubeOg) {
    ...
    SC_CTOR(DEBLUR_mac_mulsubeOg):  simcore_mac_0_U ("simcore_mac_0_U") {
