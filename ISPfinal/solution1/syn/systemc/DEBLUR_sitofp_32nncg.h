...
// ==============================================================
#ifndef __DEBLUR_sitofp_32nncg__HH__
#define __DEBLUR_sitofp_32nncg__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(DEBLUR_sitofp_32nncg) {
    ...
    SC_CTOR(DEBLUR_sitofp_32nncg):  ACMP_sitofp_U ("ACMP_sitofp_U") {
