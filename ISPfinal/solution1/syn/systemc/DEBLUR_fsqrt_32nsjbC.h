...
// ==============================================================
#ifndef __DEBLUR_fsqrt_32nsjbC__HH__
#define __DEBLUR_fsqrt_32nsjbC__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(DEBLUR_fsqrt_32nsjbC) {
    ...
    SC_CTOR(DEBLUR_fsqrt_32nsjbC):  ACMP_fsqrt_U ("ACMP_fsqrt_U") {
