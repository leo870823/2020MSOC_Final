...
// ==============================================================
#ifndef __DEBLUR_fptrunc_64ocq__HH__
#define __DEBLUR_fptrunc_64ocq__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(DEBLUR_fptrunc_64ocq) {
    ...
    SC_CTOR(DEBLUR_fptrunc_64ocq):  ACMP_fptrunc_U ("ACMP_fptrunc_U") {
