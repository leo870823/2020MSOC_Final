...
// ==============================================================
#ifndef __DEBLUR_fcmp_32ns_qcK__HH__
#define __DEBLUR_fcmp_32ns_qcK__HH__
#include "ACMP_fcmp.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(DEBLUR_fcmp_32ns_qcK) {
    ...
    SC_CTOR(DEBLUR_fcmp_32ns_qcK):  ACMP_fcmp_U ("ACMP_fcmp_U") {
        ACMP_fcmp_U.clk(clk);
