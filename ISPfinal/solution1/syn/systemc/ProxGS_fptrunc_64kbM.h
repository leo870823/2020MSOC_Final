...
// ==============================================================
#ifndef __ProxGS_fptrunc_64kbM__HH__
#define __ProxGS_fptrunc_64kbM__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(ProxGS_fptrunc_64kbM) {
    ...
    SC_CTOR(ProxGS_fptrunc_64kbM):  ACMP_fptrunc_U ("ACMP_fptrunc_U") {
