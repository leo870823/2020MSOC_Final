...
#include "start_for_fft_conlbW.h"
#include "start_for_dummy_pmb6.h"
...
struct fft_top : public sc_module {
    ...
    sc_signal< sc_lv<14> > dummy_proc_fe_1_U0_in_r_address0;
    sc_signal< sc_logic > dummy_proc_fe_1_U0_in_r_ce0;
    sc_signal< sc_lv<32> > dummy_proc_fe_1_U0_out_r_din;
    ...
    sc_signal< sc_lv<14> > dummy_proc_be_1_U0_out_r_address0;
    sc_signal< sc_logic > dummy_proc_be_1_U0_out_r_ce0;
    sc_signal< sc_logic > dummy_proc_be_1_U0_out_r_we0;
    sc_signal< sc_lv<32> > dummy_proc_be_1_U0_out_r_d0;
