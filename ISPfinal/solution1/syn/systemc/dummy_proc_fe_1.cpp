...
dummy_proc_fe_1::dummy_proc_fe_1(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    sensitive << ( icmp_ln149_fu_126_p2 );
    ...
    SC_METHOD(thread_icmp_ln149_fu_126_p2);
    sensitive << ( ap_CS_fsm_state2 );
    sensitive << ( i_0_reg_104 );

    SC_METHOD(thread_in_r_address0);
    sensitive << ( ap_CS_fsm_state2 );
    sensitive << ( zext_ln150_fu_138_p1 );
    ...
    SC_METHOD(thread_zext_ln150_fu_138_p1);
    sensitive << ( i_0_reg_104 );
    ...
    sc_trace(mVcdFile, icmp_ln149_fu_126_p2, "icmp_ln149_fu_126_p2");
    sc_trace(mVcdFile, i_0_reg_104, "i_0_reg_104");
    sc_trace(mVcdFile, ap_block_state1, "ap_block_state1");
    sc_trace(mVcdFile, zext_ln150_fu_138_p1, "zext_ln150_fu_138_p1");
    ...
    if ( ap_rst.read() == ap_const_logic_1) {
        ...
        if (esl_seteq<1,1,1>(ap_const_logic_1, ap_continue.read())) {
            ap_done_reg = ap_const_logic_0;
                    ...
                    esl_seteq<1,1,1>(icmp_ln149_fu_126_p2.read(), ap_const_lv1_1))) {
...
void dummy_proc_fe_1::thread_config_data_V_din() {
    config_data_V_din = esl_bitset<16,16,32,1>(config_data_V_dout.read(), ap_const_lv32_0, direction.read());
}
...
void dummy_proc_fe_1::thread_i_fu_132_p2() {
    i_fu_132_p2 = (!i_0_reg_104.read().is_01() || !ap_const_lv8_1.is_01())? sc_lv<8>(): (sc_biguint<8>(i_0_reg_104.read()) + sc_biguint<8>(ap_const_lv8_1));
}

void dummy_proc_fe_1::thread_icmp_ln149_fu_126_p2() {
    icmp_ln149_fu_126_p2 = (!i_0_reg_104.read().is_01() || !ap_const_lv8_80.is_01())? sc_lv<1>(): sc_lv<1>(i_0_reg_104.read() == ap_const_lv8_80);
}

void dummy_proc_fe_1::thread_in_r_address0() {
    in_r_address0 =  (sc_lv<7>) (zext_ln150_fu_138_p1.read());
}
...
void dummy_proc_fe_1::thread_zext_ln150_fu_138_p1() {
    zext_ln150_fu_138_p1 = esl_zext<64,8>(i_0_reg_104.read());
}
...
void dummy_proc_fe_1::thread_ap_NS_fsm() {
    switch (ap_CS_fsm.read().to_uint64()) {
        case 1 : 
            ...
            break;
        case 2 : 
            if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()) && esl_seteq<1,1,1>(icmp_ln149_fu_126_p2.read(), ap_const_lv1_1))) {
                ap_NS_fsm = ap_ST_fsm_state1;
            } else {
