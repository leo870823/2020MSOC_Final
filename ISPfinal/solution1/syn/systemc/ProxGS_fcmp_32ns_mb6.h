...
// ==============================================================
#ifndef __ProxGS_fcmp_32ns_mb6__HH__
#define __ProxGS_fcmp_32ns_mb6__HH__
#include "ACMP_fcmp.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(ProxGS_fcmp_32ns_mb6) {
    ...
    SC_CTOR(ProxGS_fcmp_32ns_mb6):  ACMP_fcmp_U ("ACMP_fcmp_U") {
        ACMP_fcmp_U.clk(clk);
