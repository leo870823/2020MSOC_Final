...
DEBLUR::DEBLUR(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    grp_cross_channel_deblur_fu_32->Img_V_address0(grp_cross_channel_deblur_fu_32_Img_V_address0);
    grp_cross_channel_deblur_fu_32->Img_V_ce0(grp_cross_channel_deblur_fu_32_Img_V_ce0);
    grp_cross_channel_deblur_fu_32->Img_V_we0(grp_cross_channel_deblur_fu_32_Img_V_we0);
    grp_cross_channel_deblur_fu_32->Img_V_d0(grp_cross_channel_deblur_fu_32_Img_V_d0);
    grp_cross_channel_deblur_fu_32->Img_V_q0(grp_cross_channel_deblur_fu_32_Img_V_q0);
    grp_cross_channel_deblur_fu_32->adjChImg_V_address0(grp_cross_channel_deblur_fu_32_adjChImg_V_address0);
    grp_cross_channel_deblur_fu_32->adjChImg_V_ce0(grp_cross_channel_deblur_fu_32_adjChImg_V_ce0);
    grp_cross_channel_deblur_fu_32->adjChImg_V_q0(refImg_R_V_q0);
    grp_cross_channel_deblur_fu_32->adjChImg_V_address1(grp_cross_channel_deblur_fu_32_adjChImg_V_address1);
    grp_cross_channel_deblur_fu_32->adjChImg_V_ce1(grp_cross_channel_deblur_fu_32_adjChImg_V_ce1);
    grp_cross_channel_deblur_fu_32->adjChImg_V_q1(refImg_R_V_q1);
    ...
    SC_METHOD(thread_adjChImg_B_V_address0);
    sensitive << ( grp_cross_channel_deblur_fu_32_Img_V_address0 );
    sensitive << ( ap_CS_fsm_state4 );

    SC_METHOD(thread_adjChImg_B_V_ce0);
    sensitive << ( grp_cross_channel_deblur_fu_32_Img_V_ce0 );
    sensitive << ( ap_CS_fsm_state4 );

    SC_METHOD(thread_adjChImg_B_V_d0);
    sensitive << ( grp_cross_channel_deblur_fu_32_Img_V_d0 );
    sensitive << ( ap_CS_fsm_state4 );

    SC_METHOD(thread_adjChImg_B_V_we0);
    sensitive << ( grp_cross_channel_deblur_fu_32_Img_V_we0 );
    sensitive << ( ap_CS_fsm_state4 );

    SC_METHOD(thread_adjChImg_G_V_address0);
    sensitive << ( grp_cross_channel_deblur_fu_32_Img_V_address0 );
    sensitive << ( ap_CS_fsm_state2 );

    SC_METHOD(thread_adjChImg_G_V_ce0);
    sensitive << ( grp_cross_channel_deblur_fu_32_Img_V_ce0 );
    sensitive << ( ap_CS_fsm_state2 );

    SC_METHOD(thread_adjChImg_G_V_d0);
    sensitive << ( grp_cross_channel_deblur_fu_32_Img_V_d0 );
    sensitive << ( ap_CS_fsm_state2 );

    SC_METHOD(thread_adjChImg_G_V_we0);
    sensitive << ( grp_cross_channel_deblur_fu_32_Img_V_we0 );
    sensitive << ( ap_CS_fsm_state2 );
    ...
    SC_METHOD(thread_grp_cross_channel_deblur_fu_32_Img_V_q0);
    sensitive << ( adjChImg_G_V_q0 );
    sensitive << ( adjChImg_B_V_q0 );
    sensitive << ( ap_CS_fsm_state2 );
    sensitive << ( ap_CS_fsm_state4 );
    ...
    SC_METHOD(thread_refImg_R_V_address0);
    sensitive << ( grp_cross_channel_deblur_fu_32_adjChImg_V_address0 );
    sensitive << ( ap_CS_fsm_state2 );
    sensitive << ( ap_CS_fsm_state4 );

    SC_METHOD(thread_refImg_R_V_address1);
    sensitive << ( grp_cross_channel_deblur_fu_32_adjChImg_V_address1 );
    sensitive << ( ap_CS_fsm_state2 );
    sensitive << ( ap_CS_fsm_state4 );

    SC_METHOD(thread_refImg_R_V_ce0);
    sensitive << ( grp_cross_channel_deblur_fu_32_adjChImg_V_ce0 );
    sensitive << ( ap_CS_fsm_state2 );
    sensitive << ( ap_CS_fsm_state4 );

    SC_METHOD(thread_refImg_R_V_ce1);
    sensitive << ( grp_cross_channel_deblur_fu_32_adjChImg_V_ce1 );
    sensitive << ( ap_CS_fsm_state2 );
    sensitive << ( ap_CS_fsm_state4 );
    ...
    sc_trace(mVcdFile, refImg_R_V_address0, "(port)refImg_R_V_address0");
    sc_trace(mVcdFile, refImg_R_V_ce0, "(port)refImg_R_V_ce0");
    sc_trace(mVcdFile, refImg_R_V_q0, "(port)refImg_R_V_q0");
    sc_trace(mVcdFile, refImg_R_V_address1, "(port)refImg_R_V_address1");
    sc_trace(mVcdFile, refImg_R_V_ce1, "(port)refImg_R_V_ce1");
    sc_trace(mVcdFile, refImg_R_V_q1, "(port)refImg_R_V_q1");
    sc_trace(mVcdFile, adjChImg_G_V_address0, "(port)adjChImg_G_V_address0");
    sc_trace(mVcdFile, adjChImg_G_V_ce0, "(port)adjChImg_G_V_ce0");
    sc_trace(mVcdFile, adjChImg_G_V_we0, "(port)adjChImg_G_V_we0");
    sc_trace(mVcdFile, adjChImg_G_V_d0, "(port)adjChImg_G_V_d0");
    sc_trace(mVcdFile, adjChImg_G_V_q0, "(port)adjChImg_G_V_q0");
    sc_trace(mVcdFile, adjChImg_B_V_address0, "(port)adjChImg_B_V_address0");
    sc_trace(mVcdFile, adjChImg_B_V_ce0, "(port)adjChImg_B_V_ce0");
    sc_trace(mVcdFile, adjChImg_B_V_we0, "(port)adjChImg_B_V_we0");
    sc_trace(mVcdFile, adjChImg_B_V_d0, "(port)adjChImg_B_V_d0");
    sc_trace(mVcdFile, adjChImg_B_V_q0, "(port)adjChImg_B_V_q0");
    ...
    sc_trace(mVcdFile, grp_cross_channel_deblur_fu_32_Img_V_address0, "grp_cross_channel_deblur_fu_32_Img_V_address0");
    sc_trace(mVcdFile, grp_cross_channel_deblur_fu_32_Img_V_ce0, "grp_cross_channel_deblur_fu_32_Img_V_ce0");
    sc_trace(mVcdFile, grp_cross_channel_deblur_fu_32_Img_V_we0, "grp_cross_channel_deblur_fu_32_Img_V_we0");
    sc_trace(mVcdFile, grp_cross_channel_deblur_fu_32_Img_V_d0, "grp_cross_channel_deblur_fu_32_Img_V_d0");
    sc_trace(mVcdFile, grp_cross_channel_deblur_fu_32_Img_V_q0, "grp_cross_channel_deblur_fu_32_Img_V_q0");
    sc_trace(mVcdFile, grp_cross_channel_deblur_fu_32_adjChImg_V_address0, "grp_cross_channel_deblur_fu_32_adjChImg_V_address0");
    sc_trace(mVcdFile, grp_cross_channel_deblur_fu_32_adjChImg_V_ce0, "grp_cross_channel_deblur_fu_32_adjChImg_V_ce0");
    sc_trace(mVcdFile, grp_cross_channel_deblur_fu_32_adjChImg_V_address1, "grp_cross_channel_deblur_fu_32_adjChImg_V_address1");
    sc_trace(mVcdFile, grp_cross_channel_deblur_fu_32_adjChImg_V_ce1, "grp_cross_channel_deblur_fu_32_adjChImg_V_ce1");
...
void DEBLUR::thread_adjChImg_B_V_address0() {
    adjChImg_B_V_address0 = grp_cross_channel_deblur_fu_32_Img_V_address0.read();
}

void DEBLUR::thread_adjChImg_B_V_ce0() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state4.read())) {
        adjChImg_B_V_ce0 = grp_cross_channel_deblur_fu_32_Img_V_ce0.read();
    } else {
        adjChImg_B_V_ce0 = ap_const_logic_0;
    }
}

void DEBLUR::thread_adjChImg_B_V_d0() {
    adjChImg_B_V_d0 = grp_cross_channel_deblur_fu_32_Img_V_d0.read();
}

void DEBLUR::thread_adjChImg_B_V_we0() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state4.read())) {
        adjChImg_B_V_we0 = grp_cross_channel_deblur_fu_32_Img_V_we0.read();
    } else {
        adjChImg_B_V_we0 = ap_const_logic_0;
    }
}

void DEBLUR::thread_adjChImg_G_V_address0() {
    adjChImg_G_V_address0 = grp_cross_channel_deblur_fu_32_Img_V_address0.read();
}

void DEBLUR::thread_adjChImg_G_V_ce0() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read())) {
        adjChImg_G_V_ce0 = grp_cross_channel_deblur_fu_32_Img_V_ce0.read();
    } else {
        adjChImg_G_V_ce0 = ap_const_logic_0;
    }
}

void DEBLUR::thread_adjChImg_G_V_d0() {
    adjChImg_G_V_d0 = grp_cross_channel_deblur_fu_32_Img_V_d0.read();
}

void DEBLUR::thread_adjChImg_G_V_we0() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read())) {
        adjChImg_G_V_we0 = grp_cross_channel_deblur_fu_32_Img_V_we0.read();
    } else {
        adjChImg_G_V_we0 = ap_const_logic_0;
    }
}
...
void DEBLUR::thread_grp_cross_channel_deblur_fu_32_Img_V_q0() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state4.read())) {
        grp_cross_channel_deblur_fu_32_Img_V_q0 = adjChImg_B_V_q0.read();
    } else if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read())) {
        grp_cross_channel_deblur_fu_32_Img_V_q0 = adjChImg_G_V_q0.read();
    } else {
        grp_cross_channel_deblur_fu_32_Img_V_q0 = "XXXXXXXX";
    }
}
...
void DEBLUR::thread_refImg_R_V_address0() {
    refImg_R_V_address0 = grp_cross_channel_deblur_fu_32_adjChImg_V_address0.read();
}

void DEBLUR::thread_refImg_R_V_address1() {
    refImg_R_V_address1 = grp_cross_channel_deblur_fu_32_adjChImg_V_address1.read();
}

void DEBLUR::thread_refImg_R_V_ce0() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()) || 
         esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state4.read()))) {
        refImg_R_V_ce0 = grp_cross_channel_deblur_fu_32_adjChImg_V_ce0.read();
    } else {
        refImg_R_V_ce0 = ap_const_logic_0;
    }
}

void DEBLUR::thread_refImg_R_V_ce1() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()) || 
         esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state4.read()))) {
        refImg_R_V_ce1 = grp_cross_channel_deblur_fu_32_adjChImg_V_ce1.read();
    } else {
        refImg_R_V_ce1 = ap_const_logic_0;
    }
}
...
void DEBLUR::thread_hdltv_gen() {
    ...
    while (1) {
        ...
        mHdltvoutHandle << " , " <<  " \"refImg_R_V_address0\" :  \"" << refImg_R_V_address0.read() << "\" ";
        mHdltvoutHandle << " , " <<  " \"refImg_R_V_ce0\" :  \"" << refImg_R_V_ce0.read() << "\" ";
        mHdltvinHandle << " , " <<  " \"refImg_R_V_q0\" :  \"" << refImg_R_V_q0.read() << "\" ";
        mHdltvoutHandle << " , " <<  " \"refImg_R_V_address1\" :  \"" << refImg_R_V_address1.read() << "\" ";
        mHdltvoutHandle << " , " <<  " \"refImg_R_V_ce1\" :  \"" << refImg_R_V_ce1.read() << "\" ";
        mHdltvinHandle << " , " <<  " \"refImg_R_V_q1\" :  \"" << refImg_R_V_q1.read() << "\" ";
        mHdltvoutHandle << " , " <<  " \"adjChImg_G_V_address0\" :  \"" << adjChImg_G_V_address0.read() << "\" ";
        mHdltvoutHandle << " , " <<  " \"adjChImg_G_V_ce0\" :  \"" << adjChImg_G_V_ce0.read() << "\" ";
        mHdltvoutHandle << " , " <<  " \"adjChImg_G_V_we0\" :  \"" << adjChImg_G_V_we0.read() << "\" ";
        mHdltvoutHandle << " , " <<  " \"adjChImg_G_V_d0\" :  \"" << adjChImg_G_V_d0.read() << "\" ";
        mHdltvinHandle << " , " <<  " \"adjChImg_G_V_q0\" :  \"" << adjChImg_G_V_q0.read() << "\" ";
        mHdltvoutHandle << " , " <<  " \"adjChImg_B_V_address0\" :  \"" << adjChImg_B_V_address0.read() << "\" ";
        mHdltvoutHandle << " , " <<  " \"adjChImg_B_V_ce0\" :  \"" << adjChImg_B_V_ce0.read() << "\" ";
        mHdltvoutHandle << " , " <<  " \"adjChImg_B_V_we0\" :  \"" << adjChImg_B_V_we0.read() << "\" ";
        mHdltvoutHandle << " , " <<  " \"adjChImg_B_V_d0\" :  \"" << adjChImg_B_V_d0.read() << "\" ";
        mHdltvinHandle << " , " <<  " \"adjChImg_B_V_q0\" :  \"" << adjChImg_B_V_q0.read() << "\" ";
