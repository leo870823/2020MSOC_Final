...
// ==============================================================
#ifndef __cross_channel_debpcA__HH__
#define __cross_channel_debpcA__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(cross_channel_debpcA) {
    ...
    SC_CTOR(cross_channel_debpcA):  ACMP_fpext_U ("ACMP_fpext_U") {
