...
// ==============================================================
#ifndef __DEBLUR_faddfsub_3bkb__HH__
#define __DEBLUR_faddfsub_3bkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(DEBLUR_faddfsub_3bkb) {
    ...
    SC_CTOR(DEBLUR_faddfsub_3bkb):  ACMP_faddfsub_U ("ACMP_faddfsub_U") {
