...
// ==============================================================
#ifndef __cross_channel_debqcK__HH__
#define __cross_channel_debqcK__HH__
#include "ACMP_fcmp.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(cross_channel_debqcK) {
    ...
    SC_CTOR(cross_channel_debqcK):  ACMP_fcmp_U ("ACMP_fcmp_U") {
        ACMP_fcmp_U.clk(clk);
