...
// ==============================================================
#ifndef __DEBLUR_sitodp_32sdEe__HH__
#define __DEBLUR_sitodp_32sdEe__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(DEBLUR_sitodp_32sdEe) {
    ...
    SC_CTOR(DEBLUR_sitodp_32sdEe):  ACMP_sitodp_U ("ACMP_sitodp_U") {
