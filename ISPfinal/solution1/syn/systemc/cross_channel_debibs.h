...
// ==============================================================
#ifndef __cross_channel_debibs__HH__
#define __cross_channel_debibs__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(cross_channel_debibs) {
    ...
    SC_CTOR(cross_channel_debibs):  ACMP_sitodp_U ("ACMP_sitodp_U") {
