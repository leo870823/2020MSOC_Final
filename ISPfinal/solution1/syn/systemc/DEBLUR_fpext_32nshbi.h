...
// ==============================================================
#ifndef __DEBLUR_fpext_32nshbi__HH__
#define __DEBLUR_fpext_32nshbi__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(DEBLUR_fpext_32nshbi) {
    ...
    SC_CTOR(DEBLUR_fpext_32nshbi):  ACMP_fpext_U ("ACMP_fpext_U") {
