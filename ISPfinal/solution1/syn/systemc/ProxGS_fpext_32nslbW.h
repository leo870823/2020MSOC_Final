...
// ==============================================================
#ifndef __ProxGS_fpext_32nslbW__HH__
#define __ProxGS_fpext_32nslbW__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(ProxGS_fpext_32nslbW) {
    ...
    SC_CTOR(ProxGS_fpext_32nslbW):  ACMP_fpext_U ("ACMP_fpext_U") {
