...
// ==============================================================
#ifndef __ProxGS_sitofp_32njbC__HH__
#define __ProxGS_sitofp_32njbC__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(ProxGS_sitofp_32njbC) {
    ...
    SC_CTOR(ProxGS_sitofp_32njbC):  ACMP_sitofp_U ("ACMP_sitofp_U") {
