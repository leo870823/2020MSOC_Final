...
// ==============================================================
#ifndef __DEBLUR_fptrunc_64g8j__HH__
#define __DEBLUR_fptrunc_64g8j__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(DEBLUR_fptrunc_64g8j) {
    ...
    SC_CTOR(DEBLUR_fptrunc_64g8j):  ACMP_fptrunc_U ("ACMP_fptrunc_U") {
