...
architecture behav of my_filter_fx6 is 
    ...
    signal zext_ln321_2_fu_183_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal zext_ln321_2_reg_235 : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal zext_ln215_4_fu_197_p1 : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal zext_ln321_fu_174_p1 : STD_LOGIC_VECTOR (15 downto 0);
    signal zext_ln9_fu_170_p1 : STD_LOGIC_VECTOR (15 downto 0);
    signal add_ln321_fu_177_p2 : STD_LOGIC_VECTOR (15 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (icmp_ln6_reg_209 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                    zext_ln321_2_reg_235(15 downto 0) <= zext_ln321_2_fu_183_p1(15 downto 0);
            end if;
        end if;
    end process;
    zext_ln321_2_reg_235(63 downto 16) <= "000000000000000000000000000000000000000000000000";
    ...
    add_ln321_fu_177_p2 <= std_logic_vector(unsigned(zext_ln321_fu_174_p1) + unsigned(zext_ln9_fu_170_p1));
    ...
    data_in_V_address0 <= zext_ln215_4_fu_197_p1(14 - 1 downto 0);
    data_in_V_address1 <= zext_ln321_2_fu_183_p1(14 - 1 downto 0);
    ...
    data_out_V_address0 <= zext_ln321_2_reg_235(14 - 1 downto 0);
    ...
    zext_ln215_4_fu_197_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln215_fu_191_p2),64));
    zext_ln215_fu_188_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(x_reg_229),16));
    zext_ln321_2_fu_183_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln321_fu_177_p2),64));
    zext_ln321_fu_174_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(select_ln12_reg_218),16));
