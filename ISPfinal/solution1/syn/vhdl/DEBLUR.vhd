...
port (
    ...
    refImg_R_V_address0 : OUT STD_LOGIC_VECTOR (13 downto 0);
    refImg_R_V_ce0 : OUT STD_LOGIC;
    refImg_R_V_q0 : IN STD_LOGIC_VECTOR (7 downto 0);
    refImg_R_V_address1 : OUT STD_LOGIC_VECTOR (13 downto 0);
    refImg_R_V_ce1 : OUT STD_LOGIC;
    refImg_R_V_q1 : IN STD_LOGIC_VECTOR (7 downto 0);
    adjChImg_G_V_address0 : OUT STD_LOGIC_VECTOR (13 downto 0);
    adjChImg_G_V_ce0 : OUT STD_LOGIC;
    adjChImg_G_V_we0 : OUT STD_LOGIC;
    adjChImg_G_V_d0 : OUT STD_LOGIC_VECTOR (7 downto 0);
    adjChImg_G_V_q0 : IN STD_LOGIC_VECTOR (7 downto 0);
    adjChImg_B_V_address0 : OUT STD_LOGIC_VECTOR (13 downto 0);
    adjChImg_B_V_ce0 : OUT STD_LOGIC;
    adjChImg_B_V_we0 : OUT STD_LOGIC;
    adjChImg_B_V_d0 : OUT STD_LOGIC_VECTOR (7 downto 0);
    adjChImg_B_V_q0 : IN STD_LOGIC_VECTOR (7 downto 0);
...
architecture behav of DEBLUR is 
    ...
    "DEBLUR,hls_ip_2019_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=1,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xc7z020-clg400-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=8.750000,HLS_SYN_LAT=4191469,HLS_SYN_TPT=none,HLS_SYN_MEM=226,HLS_SYN_DSP=69,HLS_SYN_FF=30104,HLS_SYN_LUT=33023,HLS_VERSION=2019_2}";
    ...
    signal grp_cross_channel_deblur_fu_32_Img_V_address0 : STD_LOGIC_VECTOR (13 downto 0);
    signal grp_cross_channel_deblur_fu_32_Img_V_ce0 : STD_LOGIC;
    signal grp_cross_channel_deblur_fu_32_Img_V_we0 : STD_LOGIC;
    signal grp_cross_channel_deblur_fu_32_Img_V_d0 : STD_LOGIC_VECTOR (7 downto 0);
    signal grp_cross_channel_deblur_fu_32_Img_V_q0 : STD_LOGIC_VECTOR (7 downto 0);
    signal grp_cross_channel_deblur_fu_32_adjChImg_V_address0 : STD_LOGIC_VECTOR (13 downto 0);
    signal grp_cross_channel_deblur_fu_32_adjChImg_V_ce0 : STD_LOGIC;
    signal grp_cross_channel_deblur_fu_32_adjChImg_V_address1 : STD_LOGIC_VECTOR (13 downto 0);
    signal grp_cross_channel_deblur_fu_32_adjChImg_V_ce1 : STD_LOGIC;
...
begin
    ...
    port map (
        ...
        Img_V_address0 => grp_cross_channel_deblur_fu_32_Img_V_address0,
        Img_V_ce0 => grp_cross_channel_deblur_fu_32_Img_V_ce0,
        Img_V_we0 => grp_cross_channel_deblur_fu_32_Img_V_we0,
        Img_V_d0 => grp_cross_channel_deblur_fu_32_Img_V_d0,
        Img_V_q0 => grp_cross_channel_deblur_fu_32_Img_V_q0,
        adjChImg_V_address0 => grp_cross_channel_deblur_fu_32_adjChImg_V_address0,
        adjChImg_V_ce0 => grp_cross_channel_deblur_fu_32_adjChImg_V_ce0,
        adjChImg_V_q0 => refImg_R_V_q0,
        adjChImg_V_address1 => grp_cross_channel_deblur_fu_32_adjChImg_V_address1,
        adjChImg_V_ce1 => grp_cross_channel_deblur_fu_32_adjChImg_V_ce1,
        adjChImg_V_q1 => refImg_R_V_q1,
    ...
    adjChImg_B_V_address0 <= grp_cross_channel_deblur_fu_32_Img_V_address0;

    adjChImg_B_V_ce0_assign_proc : process(grp_cross_channel_deblur_fu_32_Img_V_ce0, ap_CS_fsm_state4)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state4)) then 
            adjChImg_B_V_ce0 <= grp_cross_channel_deblur_fu_32_Img_V_ce0;
        else 
            adjChImg_B_V_ce0 <= ap_const_logic_0;
        end if; 
    end process;

    adjChImg_B_V_d0 <= grp_cross_channel_deblur_fu_32_Img_V_d0;

    adjChImg_B_V_we0_assign_proc : process(grp_cross_channel_deblur_fu_32_Img_V_we0, ap_CS_fsm_state4)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state4)) then 
            adjChImg_B_V_we0 <= grp_cross_channel_deblur_fu_32_Img_V_we0;
        else 
            adjChImg_B_V_we0 <= ap_const_logic_0;
        end if; 
    end process;

    adjChImg_G_V_address0 <= grp_cross_channel_deblur_fu_32_Img_V_address0;

    adjChImg_G_V_ce0_assign_proc : process(grp_cross_channel_deblur_fu_32_Img_V_ce0, ap_CS_fsm_state2)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
            adjChImg_G_V_ce0 <= grp_cross_channel_deblur_fu_32_Img_V_ce0;
        else 
            adjChImg_G_V_ce0 <= ap_const_logic_0;
        end if; 
    end process;

    adjChImg_G_V_d0 <= grp_cross_channel_deblur_fu_32_Img_V_d0;

    adjChImg_G_V_we0_assign_proc : process(grp_cross_channel_deblur_fu_32_Img_V_we0, ap_CS_fsm_state2)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
            adjChImg_G_V_we0 <= grp_cross_channel_deblur_fu_32_Img_V_we0;
        else 
    ...
    grp_cross_channel_deblur_fu_32_Img_V_q0_assign_proc : process(adjChImg_G_V_q0, adjChImg_B_V_q0, ap_CS_fsm_state2, ap_CS_fsm_state4)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state4)) then 
            grp_cross_channel_deblur_fu_32_Img_V_q0 <= adjChImg_B_V_q0;
        elsif ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
            grp_cross_channel_deblur_fu_32_Img_V_q0 <= adjChImg_G_V_q0;
        else 
    ...
    refImg_R_V_address0 <= grp_cross_channel_deblur_fu_32_adjChImg_V_address0;
    refImg_R_V_address1 <= grp_cross_channel_deblur_fu_32_adjChImg_V_address1;

    refImg_R_V_ce0_assign_proc : process(grp_cross_channel_deblur_fu_32_adjChImg_V_ce0, ap_CS_fsm_state2, ap_CS_fsm_state4)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state4) or (ap_const_logic_1 = ap_CS_fsm_state2))) then 
            refImg_R_V_ce0 <= grp_cross_channel_deblur_fu_32_adjChImg_V_ce0;
        else 
    ...
    refImg_R_V_ce1_assign_proc : process(grp_cross_channel_deblur_fu_32_adjChImg_V_ce1, ap_CS_fsm_state2, ap_CS_fsm_state4)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state4) or (ap_const_logic_1 = ap_CS_fsm_state2))) then 
            refImg_R_V_ce1 <= grp_cross_channel_deblur_fu_32_adjChImg_V_ce1;
        else 
