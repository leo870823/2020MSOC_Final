...
wire   [63:0] zext_ln321_6_fu_168_p1;
reg   [63:0] zext_ln321_6_reg_193;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln21_fu_106_p2 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        zext_ln321_6_reg_193[15 : 0] <= zext_ln321_6_fu_168_p1[15 : 0];
    end
end
...
assign data_in_V_address0 = zext_ln321_6_fu_168_p1;

assign data_out_V_address0 = zext_ln321_6_reg_193;
...
assign zext_ln321_6_fu_168_p1 = add_ln321_fu_162_p2;

assign zext_ln321_fu_158_p1 = select_ln26_fu_130_p3;

always @ (posedge ap_clk) begin
    zext_ln321_6_reg_193[63:16] <= 48'b000000000000000000000000000000000000000000000000;
end
