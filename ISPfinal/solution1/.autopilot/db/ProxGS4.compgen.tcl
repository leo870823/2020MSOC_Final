...
set ID 75
set hasByteEnable 0
set MemName ProxGS4_tmp_M_real
...
set ID 76
set hasByteEnable 0
set MemName ProxGS4_fft_resuljbC
set CoreName ap_simcore_mem
set PortList { 2 0 }
set DataWd 32
set AddrRange 16384
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename x_io_V \
    op interface \
    ports { x_io_V_address0 { O 14 vector } x_io_V_ce0 { O 1 bit } x_io_V_we0 { O 1 bit } x_io_V_d0 { O 8 vector } x_io_V_q0 { I 8 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'x_io_V'"
}
}
