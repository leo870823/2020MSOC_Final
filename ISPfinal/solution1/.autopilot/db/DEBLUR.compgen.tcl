...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename refImg_R_V \
    op interface \
    ports { refImg_R_V_address0 { O 14 vector } refImg_R_V_ce0 { O 1 bit } refImg_R_V_q0 { I 8 vector } refImg_R_V_address1 { O 14 vector } refImg_R_V_ce1 { O 1 bit } refImg_R_V_q1 { I 8 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'refImg_R_V'"
}
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    sync_rst true \
    dir IO \
    corename adjChImg_G_V \
    op interface \
    ports { adjChImg_G_V_address0 { O 14 vector } adjChImg_G_V_ce0 { O 1 bit } adjChImg_G_V_we0 { O 1 bit } adjChImg_G_V_d0 { O 8 vector } adjChImg_G_V_q0 { I 8 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'adjChImg_G_V'"
}
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    sync_rst true \
    dir IO \
    corename adjChImg_B_V \
    op interface \
    ports { adjChImg_B_V_address0 { O 14 vector } adjChImg_B_V_ce0 { O 1 bit } adjChImg_B_V_we0 { O 1 bit } adjChImg_B_V_d0 { O 8 vector } adjChImg_B_V_q0 { I 8 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'adjChImg_B_V'"
}
}
