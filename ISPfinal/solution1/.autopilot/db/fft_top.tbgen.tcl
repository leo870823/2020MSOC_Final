...
set C_modelArgList {
	...
	{ in_r int 64 regular {array 128 { 1 3 } 1 1 }  }
	{ out_r int 64 regular {array 128 { 0 3 } 0 1 }  }
}
...
set portList { 
	...
	{ in_r_address1 sc_out sc_lv 7 signal 1 } 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "7", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.start_for_fft_conmb6_U", "Parent" : "0"},
	{"ID" : "8", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.start_for_dummy_pncg_U", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	...
	in_r { ap_memory {  { in_r_address0 mem_address 1 7 }  { in_r_ce0 mem_ce 1 1 }  { in_r_d0 mem_din 1 64 }  { in_r_q0 mem_dout 0 64 }  { in_r_we0 mem_we 1 1 }  { in_r_address1 mem_address 1 7 }  { in_r_ce1 mem_ce 1 1 }  { in_r_d1 mem_din 1 64 }  { in_r_q1 mem_dout 0 64 }  { in_r_we1 mem_we 1 1 } } }
	out_r { ap_memory {  { out_r_address0 mem_address 1 7 }  { out_r_ce0 mem_ce 1 1 }  { out_r_d0 mem_din 1 64 }  { out_r_q0 mem_dout 0 64 }  { out_r_we0 mem_we 1 1 }  { out_r_address1 mem_address 1 7 }  { out_r_ce1 mem_ce 1 1 }  { out_r_d1 mem_din 1 64 }  { out_r_q1 mem_dout 0 64 }  { out_r_we1 mem_we 1 1 } } }
}
