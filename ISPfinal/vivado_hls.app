<project xmlns="com.autoesl.autopilot.project" name="ISPfinal" top="DEBLUR">
    <files>
        ...
        <file name="../../tb_files/DeconvolutionColorPrior/DENOM2.txt" sc="0" tb="1" cflags=""/>
        <file name="../../tb_files/DeconvolutionColorPrior/DENOM3.txt" sc="0" tb="1" cflags=""/>
        <file name="../../tb_files/DeconvolutionColorPrior/IMAGINARY.txt" sc="0" tb="1" cflags=""/>
        <file name="../../tb_files/DeconvolutionColorPrior/IMAGINARY2.txt" sc="0" tb="1" cflags=""/>
        <file name="../../tb_files/DeconvolutionColorPrior/IMAGINARY3.txt" sc="0" tb="1" cflags=""/>
        ...
        <file name="../../tb_files/DeconvolutionColorPrior/REAL2.txt" sc="0" tb="1" cflags=""/>
        <file name="../../tb_files/DeconvolutionColorPrior/REAL3.txt" sc="0" tb="1" cflags=""/>
