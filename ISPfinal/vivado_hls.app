<project xmlns="com.autoesl.autopilot.project" name="ISPfinal" top="DEBLUR">
    <files>
        ...
        <file name="../../pattern/DENOM2.txt" sc="0" tb="1" cflags=""/>
        <file name="../../pattern/DENOM3.txt" sc="0" tb="1" cflags=""/>
        <file name="../../tb_files/DeconvolutionColorPrior/IMAGINARY.txt" sc="0" tb="1" cflags=""/>
        <file name="../../pattern/IMAGINARY2.txt" sc="0" tb="1" cflags=""/>
        <file name="../../pattern/IMAGINARY3.txt" sc="0" tb="1" cflags=""/>
        ...
        <file name="../../pattern/REAL2.txt" sc="0" tb="1" cflags=""/>
        <file name="../../pattern/REAL3.txt" sc="0" tb="1" cflags=""/>
